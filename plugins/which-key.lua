  ...
  config = function(plugin, opts)
    ...
    wk.register({
      ...
      ["<leader>lt"]={
        ...
        o ={':lua require("neotest").output.open({ enter = true })<CR>',"show test output",mode={"n","v"}},
        lo ={':lua require("neotest").output.open({ enter = true,last_run=true })<CR>',"show last test output",mode={"n","v"}},
